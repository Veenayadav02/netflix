// Consts
const apikey = "cc492e88287b19683159dcea9efbbd8c";
...
const apiPaths = {
    ...
    searchOnYoutube: (query) => `https://www.googleapis.com/youtube/v3/search?part=snippet&q=${query}trailer&key=AIzaSyDW4rmzl37iQfO8lpTw5IPOFrEaDGqzTIQ`
}
...
function searchMovieTrailer(movieName, iframId) {
    ...
    fetch(apiPaths.searchOnYoutube(movieName))
        ...
        .then(res => {
            ...
            const youtubeUrl = 'https://www.youtube.com/watch?v=${bestResult.id.viedoId}';
